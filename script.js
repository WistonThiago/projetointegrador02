...
function createParagraph(estado) {
    let paragraph = document.createElement("p");
    paragraph.innerText = `${estados.find(e => e.hasOwnProperty(estado))[estado]}`

    let content = document.getElementById("jscontent");
    content.appendChild(paragraph);
}
// Exemplo de uso para o estado do Acre
createParagraph('al');